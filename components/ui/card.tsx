...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-white/5 border border-white/10 text-card-foreground flex flex-col gap-4 rounded-lg p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:border-white/20',
        className,
      )}
      {...props}
    />
